      ...
      <div className="relative max-w-6xl mx-auto px-4 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link
              href="/"
              className="inline-block mb-4 text-zinc-900 dark:text-white tracking-tight"
            >
              <span className="block text-3xl font-black leading-tight">
                MSAFIRI
              </span>
              <span className="block text-sm font-semibold uppercase tracking-[0.25em] text-zinc-500 dark:text-zinc-400">
                Contractors Ltd
              </span>
            </Link>
            <p className="text-sm text-zinc-400 mb-4 leading-relaxed">
              Your trusted partner for premium security solutions. Protecting
              homes and businesses across Uganda with cutting-edge technology.
            </p>
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://linkedin.com/company/msafiricontractors"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-400 hover:bg-zinc-700 hover:text-white transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
            <p className="text-xs text-zinc-500">
              &copy; {new Date().getFullYear()} Msafiri Contractors Ltd. All
              rights reserved.
            </p>
